...
class JobService:
    ...
    def _get_required_resources(self, index_build_parameters: IndexBuildParameters) -> tuple[float, float]:
        gpu_mem, cpu_mem = calculate_memory_requirements(
            index_build_parameters.dimension,
            index_build_parameters.doc_count,
            index_build_parameters.data_type,
    ...
    def _create_workflow(self, job_id: str, gpu_mem: float, cpu_mem: float, index_build_parameters: IndexBuildParameters) -> BuildWorkflow:
    ...
    def create_job(self, index_build_parameters: IndexBuildParameters) -> str:
        ...
        Args:
            index_build_parameters: The job creation request containing necessary parameters
        ...
        try:
            workflow = self._create_workflow(job_id, gpu_mem, cpu_mem, index_build_parameters)
            logger.info(
